...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    displaySmall: const TextStyle().copyWith(
        fontSize: 16.sp, fontWeight: FontWeight.w300, color: TColors.dark),
    ...
    titleMedium: const TextStyle().copyWith(
        fontSize: 14.sp, fontWeight: FontWeight.w600, color: TColors.dark),
    titleSmall: const TextStyle().copyWith(
        fontSize: 14.sp, fontWeight: FontWeight.w400, color: TColors.dark),
    ...
    bodySmall: const TextStyle().copyWith(
        fontSize: 14.sp, fontWeight: FontWeight.w500, color: TColors.textLight),
    labelLarge: const TextStyle().copyWith(
        fontSize: 12.sp, fontWeight: FontWeight.bold, color: TColors.dark),
